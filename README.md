...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create communitree-frontend-1ce4
  fly apps create communitree-frontend-1ce4-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app communitree-frontend-1ce4
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app communitree-frontend-1ce4-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'communitree-frontend-1ce4-staging' does not match app name in config file 'communitree-frontend-1ce4'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name communitree-frontend-1ce4-db
  fly postgres attach --app communitree-frontend-1ce4 communitree-frontend-1ce4-db

  fly postgres create --name communitree-frontend-1ce4-staging-db
  fly postgres attach --app communitree-frontend-1ce4-staging communitree-frontend-1ce4-staging-db
  ```
